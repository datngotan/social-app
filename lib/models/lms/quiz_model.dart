import 'package:socialNetwork/models/lms/lms_common_models/course_data.dart';
...
class QuizModel {
  ...
  factory QuizModel.fromJson(Map<String, dynamic> json) {
    return QuizModel(
      assigned:
          json['assigned'] != null ? Assigned.fromJson(json['assigned']) : null,
...
class Results {
  ...
  factory Results.fromJson(Map<String, dynamic> json) {
    return Results(
      attempts: json['attempts'] != null
          ? (json['attempts'] as List).map((i) => ResultsX.fromJson(i)).toList()
          : null,
      checked_questions: json['checked_questions'] != null
          ? (json['checked_questions'] as List)
      ...
      question_ids: json['question_ids'] != null
          ? new List<int>.from(json['question_ids'])
          : null,
      questions_per_page: json['questions_per_page'],
      results:
          json['results'] != null ? ResultsX.fromJson(json['results']) : null,
      retake_count: json['retake_count'],
      retaken: json['retaken'],
      review_questions: json['review_questions'],
      start_time: json['start_time'],
      status: json['status'],
      support_options: json['support_options'] != null
          ? new List<String>.from(json['support_options'])
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.checked_questions != null) {
      data['checked_questions'] =
          this.checked_questions!.map((v) => v.toJson()).toList();
    }
...
class MetaData {
  ...
  MetaData(
      {this.lp_duration,
      this.lp_instant_check,
      this.lp_minus_skip_questions,
      this.lp_negative_marking,
      this.lp_pagination,
      this.lp_passing_grade,
      this.lp_retake_count,
      this.lp_review,
      this.lp_show_correct_review});
...
class QuestionAnsweresModel {
  ...
  QuestionAnsweresModel(
      {this.answered, this.correct, this.explanation, this.mark, this.options});
