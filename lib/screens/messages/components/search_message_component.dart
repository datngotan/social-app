...
import 'package:socialNetwork/screens/messages/components/message_member_component.dart';
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return MessageMemberComponent(
                          user: widget.searchResponse.friends.validate()[index])
          ...
          Column(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return MessageMemberComponent(
                          user: widget.searchResponse.users.validate()[index])
                      .paddingSymmetric(vertical: 8);
                },
              ),
            ],
          ...
          Column(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  SearchMessage msg =
                      widget.searchResponse.messages.validate()[index];
                  MessagesUsers user;

                  Threads thread = widget.searchResponse.updateData!.threads
                      .validate()
                      .firstWhere(
                          (element) => element.threadId == msg.threadId);

                  if (thread.participantsCount.validate() >= 2) {
                    user = widget.searchResponse.updateData!.users
                        .validate()
                        .firstWhere((element) =>
                  ...
                  Messages message = widget.searchResponse.updateData!.messages
                      .validate()
                      .firstWhere((element) =>
                          element.messageId.validate() ==
                          msg.messageId.validate());
