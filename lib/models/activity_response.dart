...
import 'package:socialNetwork/models/common_models/collection.dart';
import 'package:socialNetwork/models/common_models/content.dart';
import 'package:socialNetwork/models/common_models/user.dart';
  ...
  factory ActivityResponse.fromJson(Map<String, dynamic> json) {
    return ActivityResponse(
      ...
      userAvatar: json['user_avatar'] != null
          ? AvatarUrls.fromJson(json['user_avatar'])
          : null,
      userId: json['user_id'],
      name: json['name'],
    );
...
class Links {
  ...
  factory Links.fromJson(Map<String, dynamic> json) {
    return Links(
      bpActionFavorite: json['bp-action-favorite'] != null
          ? (json['bp-action-favorite'] as List)
      ...
      favorite: json['favorite'] != null
          ? (json['favorite'] as List).map((i) => Favorite.fromJson(i)).toList()
          : null,
      self: json['self'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.bpActionFavorite != null) {
      data['bp-action-favorite'] =
          this.bpActionFavorite!.map((v) => v.toJson()).toList();
    }
