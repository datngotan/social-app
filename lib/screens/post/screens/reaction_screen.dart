...
class ReactionScreen extends StatefulWidget {
  ...
  const ReactionScreen(
      {Key? key, required this.postId, required this.isCommentScreen})
      : super(key: key);
          ...
          children: [
            ...
            if (list.isNotEmpty)
              AnimatedListView(
                ...
                padding:
                    EdgeInsets.only(left: 16, right: 16, bottom: 50, top: 50),
                ...
                itemBuilder: (ctx, index) {
                  ...
                  if (e.count != 0)
                    return TextIcon(
                      ...
                      text: e.id == "0"
                          ? '${e.title.validate().capitalizeFirstLetter()} (${e.count.validate()})'
                          : e.count.validate().toString(),
