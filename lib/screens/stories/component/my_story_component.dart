...
import 'package:socialNetwork/screens/stories/component/story_views_component.dart';
    ...
    return Observer(
      builder: (_) => Stack(
        children: [
                      ...
                      Row(
                        children: [
                          story.mediaType == MediaTypes.video
                              ? Container(
                                  decoration:
                                      BoxDecoration(borderRadius: radius(24)),
                                  height: 48,
                                  width: 48,
                                  child: ShowVideoThumbnail(
                                      videoUrl: story.storyMedia),
                                )
                              : CachedNetworkImage(
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                  '${story.viewCount.validate().toString()} ${language.views}',
                                  style: boldTextStyle()),
          ...
          if ((widget.list.isEmpty || widget.list[0].items!.isEmpty) &&
              !appStore.isLoading)
            Column(
              mainAxisSize: MainAxisSize.min,
              children: [
