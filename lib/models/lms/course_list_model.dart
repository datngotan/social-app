...
import 'package:socialNetwork/models/lms/lms_common_models/lms_category.dart';
import 'package:socialNetwork/models/lms/lms_common_models/section.dart';
...
class CourseListModel {
  ...
  factory CourseListModel.fromJson(Map<String, dynamic> json) {
    return CourseListModel(
      ...
      course_data: json['course_data'] != null
      ...
      meta_data: json['meta_data'] != null
          ? CourseMetaData.fromJson(json['meta_data'])
          : null,
      name: json['name'],
