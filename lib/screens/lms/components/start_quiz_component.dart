          ...
          Wrap(
            ...
            children: [
              Row(
                ...
                children: [
                  cachedImage(ic_time_filled,
                      height: 16,
                      width: 16,
                      fit: BoxFit.cover,
                      color: context.primaryColor),
                  4.width,
                  Text('${language.duration}: ${quiz.duration.validate()}',
              ...
              Row(
                ...
                children: [
                  ...
                  4.width,
                  Text(
                      '${language.passingGrade}: ${quiz.meta_data!.lp_passing_grade.validate()}',
                      style: secondaryTextStyle()),
                ],
              ),
              Row(
                ...
                children: [
                  ...
                  4.width,
                  Text(
                      '${language.questions}: ${quiz.questions.validate().length}',
                      style: secondaryTextStyle()),
                ],
              ),
            ],
              ...
              ifNotTester(() {
                ...
                startQuiz(quizId: quiz.id.validate()).then((value) async {
                  ...
                  lmsStore.quizList.add(QuizAnswers(
                    ...
                    isHours:
                        quiz.duration.validate().split(' ').last == 'hours',
                  ));
