  ...
  factory Previous.fromJson(Map<String, dynamic> json) {
    return Previous(
      ...
      capabilities: json['capabilities'] != null
          ? new List<String>.from(json['capabilities'])
          : null,
      date_modified: json['date_modified'],
      date_modified_gmt: json['date_modified_gmt'],
      extra_capabilities: json['extra_capabilities'] != null
          ? new List<String>.from(json['extra_capabilities'])
          : null,
      ...
      name: json['name'],
      registered_date:
          json['registered_date'] != null ? json['registered_date'] : null,
      registered_date_gmt: json['registered_date_gmt'] != null
          ? json['registered_date_gmt']
          : null,
      roles:
          json['roles'] != null ? new List<String>.from(json['roles']) : null,
