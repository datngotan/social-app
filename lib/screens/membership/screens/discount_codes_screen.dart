    ...
    return AppScaffold(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            PlanSubtitleComponent(
                                plan: code.plans.validate().first),
                            8.height,
                            Text('${language.validTill} ${code.expires}',
      ...
      bottomNavigationBar: selectedCode != null
          ? AppButton(
              ...
              onTap: () {
                widget.onApply(selectedCode!.code.validate(),
                    selectedCode!.plans.validate().first);
              },
            ).paddingAll(16)
          : Offstage(),
    );
