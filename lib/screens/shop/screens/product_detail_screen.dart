...
import 'package:socialNetwork/models/woo_commerce/variation_model.dart';
import 'package:socialNetwork/network/rest_apis.dart';
import 'package:socialNetwork/screens/shop/components/price_widget.dart';
import 'package:socialNetwork/screens/shop/components/product_card_component.dart';
import 'package:socialNetwork/screens/shop/components/product_review_component.dart';
import 'package:socialNetwork/screens/shop/screens/cart_screen.dart';
import 'package:socialNetwork/screens/shop/screens/shop_screen.dart';
    ...
    await getProductDetail(productId: widget.id.validate()).then((value) {
      ...
      value.forEach((element) {
        ...
        if (index == 0) {
          ...
          groupProductList.add(
              GroupProductModel(id: element.id.validate(), product: element));
          setState(() {});
        }
      });
                  ...
                  body: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            RatingBarWidget(
                              ...
                              rating:
                                  product.averageRating.validate().toDouble(),
                              size: 18,
                              disable: true,
                            ),
                            16.width,
                        ...
                        16.height,
                        if (product.shortDescription.validate().isNotEmpty)
                        ...
                        if (mainProduct.type == ProductTypes.variable)
                          Column(
                            children:
                                mainProduct.attributes.validate().map((e) {
                              return Row(
                                children: [
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: ButtonTheme(
                                        ...
                                        child: DropdownButton<String>(
                                          ...
                                          hint: Text(language.chooseAnOption,
                                              style: secondaryTextStyle()),
                                          items: e.options
                                              .validate()
                        ...
                        if (product.attributes.validate().isNotEmpty)
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(language.additionalInformation,
                                      style: boldTextStyle())
                                  .paddingSymmetric(horizontal: 16),
                              Table(
                                columnWidths: {
                                ...
                                border: TableBorder.all(
                                  color: appStore.isDarkMode
                                      ? bodyDark.withOpacity(0.2)
                                      : bodyWhite.withOpacity(0.2),
                                  style: BorderStyle.solid,
                                  width: 2,
                                ),
                                children:
                                    product.attributes.validate().map((e) {
                                  return TableRow(
                                    children: [
                                      Text(
                                        e.name.validate(),
                              ...
                              HorizontalList(
                                ...
                                itemBuilder: (ctx, index) {
                                  return RelatedProductCardComponent(
                                      product:
                                          product.relatedProductList![index]);
                                },
                              ).visible(!isLoading),
                            ],
                          ),
                  ...
                  IconButton(
                    onPressed: () {
                      if (isWishListed) {
                        ...
                        removeFromWishlist(productId: product.id.validate())
                            .then((value) {
                          //
                        }).catchError((e) {
                          isWishListed = true;
                        ...
                        addToWishlist(productId: product.id.validate())
                            .then((value) {
                          //
                        }).catchError((e) {
                          isWishListed = false;
