...
import 'package:socialNetwork/screens/lms/screens/lesson_screen.dart';
import 'package:socialNetwork/screens/lms/screens/quiz_screen.dart';
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if (e.status == CourseStatus.completed &&
                                  e.graduation == CourseStatus.failed)
                                Image.asset(ic_close,
                                    color: Colors.red,
                                    height: 14,
                                    fit: BoxFit.cover),
                              if (e.locked.validate())
                                Icon(Icons.lock,
                                    color: appGreenColor, size: 14),
                            ],
                          ),
                          if (widget.showCheck)
                            InkWell(
                              child: Container(
                                child: Text(language.preview,
                                    style: primaryTextStyle(
