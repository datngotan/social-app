    ...
    return Stack(
      ...
      children: [
            ...
            if (snap.hasData) {
              if (snap.data.validate().isEmpty) {
                ...
                return AnimatedListView(
                  ...
                  padding:
                      EdgeInsets.only(left: 16, right: 16, bottom: 50, top: 60),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        MemberProfileScreen(
                                memberId: memberList[index].userId.validate())
                            .launch(context);
                      },
                      child: Row(
                        children: [
                          ...
                          Text(
                              convertToAgo(
                                  member.seenTime.validate().toString()),
                              style: secondaryTextStyle()),
                        ],
        ...
        Container(
          ...
          child: Text('${language.viewedBy} ${widget.viewCount}',
