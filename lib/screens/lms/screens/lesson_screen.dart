          ...
          if (isFetched)
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(lesson.name.validate(), style: boldTextStyle(size: 18))
                      .paddingAll(16),
                  HtmlWidget(postContent: lesson.content.validate())
                      .paddingAll(12),
                  if (widget.isEnrolled)
                    if (lesson.results!.status.validate() ==
                        ...
                        onTap: () {
                          showConfirmDialogCustom(
                            ...
                            onAccept: (c) {
                              ifNotTester(() {
                                appStore.setLoading(true);
                                finishLesson(lessonId: widget.lessonId)
                                    .then((value) {
                                  isChanged = true;
                                  appStore.setLoading(false);
