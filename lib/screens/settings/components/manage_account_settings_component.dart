...
import 'package:socialNetwork/screens/blockReport/blocked_accounts.dart';
import 'package:socialNetwork/screens/membership/screens/membership_plans_screen.dart';
import 'package:socialNetwork/screens/settings/components/request_verification_dialog.dart';
import 'package:socialNetwork/screens/settings/screens/send_invitations_screen.dart';
      ...
      items: [
        SettingItemWidget(
          ...
          leading: Image.asset(ic_message,
              height: 18, width: 18, color: appColorPrimary, fit: BoxFit.cover),
        ...
        Observer(
          builder: (_) => SettingItemWidget(
            ...
            trailing: appStore.verificationStatus ==
                    ...
                    appStore.verificationStatus == VerificationStatus.pending
                ? Container(
                    ...
                    child: Text(
                        appStore.verificationStatus.capitalizeFirstLetter(),
                        style: secondaryTextStyle(color: Colors.white)),
                  )
                : Offstage(),
            onTap: () {
              if (appStore.verificationStatus == VerificationStatus.rejected ||
