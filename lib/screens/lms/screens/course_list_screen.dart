...
import 'package:socialNetwork/screens/lms/components/empty_mycourse_component.dart';
...
class _CourseListScreenState extends State<CourseListScreen> {
  ...
  Future<List<CourseListModel>> getCourses() async {
    ...
    if (widget.myCourses) {
      await getCourseList(page: mPage, myCourse: true, status: status)
          .then((value) {
      ...
      await getCourseList(page: mPage, categoryId: widget.categoryId)
          .then((value) {
        if (mPage == 1) courseList.clear();
        mIsLastPage = value.length != PER_PAGE;
        courseList.addAll(value);
                    ...
                    children: [
                      ...
                      AnimatedListView(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return CourseCardComponent(course: data)
