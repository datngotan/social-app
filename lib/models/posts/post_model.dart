...
class PostModel {
    ...
    return PostModel(
      ...
      reactions: json['reactions'] != null
          ? (json['reactions'] as List)
              .map((i) => Reactions.fromJson(i))
              .toList()
          : null,
      curUserReaction: json['cur_user_reaction'] != null
          ? Reactions.fromJson(json['cur_user_reaction'])
          : null,
      reactionCount: json['reaction_count'],
      isPinned: json['is_pinned'],
      contentObject: json['content_object'] != null &&
              json['content_object'].runtimeType == (List<dynamic>)
          ? (json['content_object'] as List)
              .map((i) => ContentObject.fromJson(i))
              .toList()
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.contentObject != null) {
      data['content_object'] =
          this.contentObject!.map((v) => v.toJson()).toList();
    }
