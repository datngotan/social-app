...
class SearchMessageResponse {
  ...
  SearchMessageResponse.fromJson(dynamic json) {
    users = json['users'] != null
        ? (json['users'] as List).map((i) => MessagesUsers.fromJson(i)).toList()
        : null;
    friends = json['friends'] != null
        ? (json['friends'] as List)
            .map((i) => MessagesUsers.fromJson(i))
            .toList()
        : null;
    messages = json['messages'] != null
        ? (json['messages'] as List)
            .map((i) => SearchMessage.fromJson(i))
            .toList()
        : null;
    updateData = json['updateData'] != null
        ? ThreadsListModel.fromJson(json['updateData'])
        : null;
  }
