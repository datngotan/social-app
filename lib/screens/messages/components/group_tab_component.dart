          ...
          return AnimatedListView(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: () {
                  String message =
                      '42["${SocketEvents.threadOpen}",${group.threadId.validate()}]';
                  String messageOne =
                      '421["${SocketEvents.v3GetStatuses}",[${group.threadId.validate()}]]';
                ...
                child: Container(
                  ...
                  child: TextIcon(
                    prefix: cachedImage(group.image,
                    ...
                    suffix: Tooltip(
                      richMessage: TextSpan(
                          text: language.groupHomepage,
                          style: secondaryTextStyle(color: Colors.white)),
                      child: IconButton(
                        icon: cachedImage(ic_home,
