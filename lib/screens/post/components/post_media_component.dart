...
import 'package:socialNetwork/components/youtube_player_component.dart';
import 'package:socialNetwork/main.dart';
import 'package:socialNetwork/models/common_models/post_mdeia_model.dart';
import 'package:socialNetwork/screens/post/components/audio_component.dart';
import 'package:socialNetwork/screens/post/components/video_post_component.dart';
import 'package:socialNetwork/screens/post/screens/audio_post_screen.dart';
import 'package:socialNetwork/screens/post/screens/image_screen.dart';
                ...
                if (widget.mediaType == MediaTypes.photo) {
                  ...
                  return Container(
                    ...
                    if (widget.mediaList.validate()[index].url.validate().isPdf)
                      ...
                      openWebPage(context,
                          url:
                              '$openDocUrlPrefix${widget.mediaList.validate()[index].url.validate()}');
                  },
                      splashColor: Colors.transparent,
                      highlightColor: Colors.transparent);
