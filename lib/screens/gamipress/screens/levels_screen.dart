                ...
                return AnimatedListView(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          if (level.image.validate().isNotEmpty)
                            cachedImage(level.image.validate(),
                                height: 100, fit: BoxFit.cover),
                          16.height,
                          Text(
                              parseHtmlString(level.title!.rendered.validate()),
                            ...
                            Row(
                              ...
                              children: [
                                Text('${language.requirements}:',
                                    style: primaryTextStyle()),
                                Text('${level.requirements.validate().length}',
                                    style: primaryTextStyle()),
                              ],
                            ),
                            8.height,
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: secondaryTextStyle(
                                          decoration: e.hasEarned.validate()
