...
import 'package:socialNetwork/components/no_data_lottie_widget.dart';
...
import 'package:socialNetwork/network/lms_rest_apis.dart';
import 'package:socialNetwork/screens/lms/components/course_card_component.dart';
import 'package:socialNetwork/screens/lms/components/course_includes_tab_component.dart';
import 'package:socialNetwork/screens/lms/components/curriculam_tab_component.dart';
import 'package:socialNetwork/screens/lms/components/faq_tab_component.dart';
import 'package:socialNetwork/screens/lms/components/instructor_tab_component.dart';
import 'package:socialNetwork/screens/lms/components/overview_tab_component.dart';
import 'package:socialNetwork/screens/lms/components/review_tab_component.dart';
import 'package:socialNetwork/screens/lms/components/start_course_widget.dart';
import 'package:socialNetwork/screens/lms/screens/buy_course_screen.dart';
import 'package:socialNetwork/screens/lms/screens/course_sections_screen.dart';
...
class _CourseDetailScreenState extends State<CourseDetailScreen> {
  ...
  Future<CourseListModel> getCourseDetail(
      {bool isCourseStarted = false}) async {
                    ...
                    child: Column(
                      children: [
                        ...
                        if (course!.course_data!.status ==
                          ...
                          Row(
                            children: [
                              Text('${language.courseResults}: ${course!.course_data!.result!.result.validate()}%',
                                      style: boldTextStyle())
                              ...
                              SizedBox(
                                ...
                                child: LinearProgressIndicator(
                                  ...
                                  backgroundColor: appStore.isDarkMode
                                      ? bodyDark.withOpacity(0.4)
                                      : bodyWhite.withOpacity(0.4),
                        ...
                        if (course!.course_data!.status ==
                          ...
                          appButton(
                            ...
                            onTap: () {
                              CourseSectionsScreen(
                                sections: course!.sections,
                                isEnrolled: course!.course_data!.status ==
                                    CourseStatus.enrolled,
                                callback: () {
                                  future =
                        ...
                        else if (course!.course_data!.status
                                .validate()
                                .isEmpty &&
                          ...
                          appButton(
                            ...
                            onTap: () {
                              ifNotTester(() {
                                appStore.setLoading(true);
                                enrollCourse(courseId: widget.courseId)
                                    .then((value) {
                                  course!.course_data!.status =
                                      CourseStatus.enrolled;
                                  onRefresh();
                          ...
                          appButton(
                            ...
                            context: context,
                            text:
                                '${language.retake} (${course!.ratake_count.validate() - course!.rataken.validate()})',
                            onTap: () {
                              ifNotTester(() {
                                appStore.setLoading(true);
                                retakeCourse(courseId: widget.courseId)
                                    .then((value) {
                                  course!.course_data!.status =
                                      CourseStatus.enrolled;
                                  onRefresh();
                          ...
                          if (course!.in_cart.validate())
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border(
                                    left: BorderSide(
                                        color: appGreenColor, width: 2)),
                              ),
                              padding: EdgeInsets.all(14),
                              child: Text(
                                  '${language.yourOrderIsWaitingFor} ${course!.order_status.validate()}',
                                  style:
                                      primaryTextStyle(color: appGreenColor)),
                            )
                          else
                            appButton(
                              width: context.width() / 2 - 20,
                              ...
                              onTap: () {
                                BuyCourseScreen(
                                  ...
                                  coursePriseRendered:
                                      course!.price_rendered.validate(),
                        ...
                        else if (course!.course_data!.status.validate() ==
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border(
                                  left: BorderSide(
                                      color: blueTickColor, width: 2)),
                            ),
                            child: Text(language.youHaveFinishedThisCourse,
                                style: primaryTextStyle(color: blueTickColor)),
                          )
                        else
                          Offstage(),
