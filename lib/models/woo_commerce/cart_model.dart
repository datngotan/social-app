...
import 'package:socialNetwork/models/woo_commerce/totals_final.dart';
    ...
    return CartModel(
      ...
      coupons: json['coupons'] != null
          ? (json['coupons'] as List)
              .map((i) => CartCouponModel.fromJson(i))
              .toList()
          : null,
      crossSells: json['cross_sells'] != null
          ? (json['cross_sells'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      errors: json['errors'] != null
          ? (json['errors'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      extensions: json['extensions'] != null
          ? Extensions.fromJson(json['extensions'])
          : null,
      fees: json['fees'] != null
          ? (json['fees'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      ...
      paymentRequirements: json['payment_requirements'] != null
          ? new List<String>.from(json['payment_requirements'])
          : null,
      shippingAddress: json['shipping_address'] != null
          ? BillingAddressModel.fromJson(json['shipping_address'])
          : null,
      totals:
          json['totals'] != null ? TotalsFinal.fromJson(json['totals']) : null,
    );
  }
  ...
  factory CartCouponModel.fromJson(Map<String, dynamic> json) {
    return CartCouponModel(
      ...
      totals: json['totals'] != null
          ? CouponTotalsModel.fromJson(json['totals'])
          : null,
    );
  }
