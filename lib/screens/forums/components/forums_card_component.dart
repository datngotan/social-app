  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(parseHtmlString(title.validate()),
              style: boldTextStyle(size: 18)),
          8.height,
          Text(description.validate(),
                    ...
                    children: freshness.validate().take(3).map((e) {
                      return Container(
                        ...
                        margin: EdgeInsets.only(
                            left: 18 *
                                freshness.validate().indexOf(e).toDouble()),
                        child: cachedImage(
                          freshness
                              .validate()[freshness.validate().indexOf(e)]
                              .userProfileImage
                              .validate(),
                          fit: BoxFit.cover,
