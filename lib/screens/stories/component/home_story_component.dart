...
import 'package:socialNetwork/screens/stories/screen/story_page.dart';
...
class _HomeStoryComponentState extends State<HomeStoryComponent>
              ...
              child: Row(
                ...
                children: [
                        ...
                        child: Stack(
                          ...
                          children: [
                            Container(
                              ...
                              child: cachedImage(appStore.loginAvatarUrl,
                          ...
                          FileTypes? file = await showInDialog(
                            ...
                            builder: (p0) {
                              return FilePickerDialog(
                                  isSelected: true, showCameraVideo: true);
                            },
                          );

                          if (file != null) {
                            if (file == FileTypes.CAMERA) {
                              await getImageSource(isCamera: true)
                                  .then((value) {
                                appStore.setLoading(false);
                                CreateStoryScreen(cameraImage: value)
                                    .launch(context)
                                    .then((value) {
                                  if (value ?? false) {
                                    list.clear();
                              ...
                              await getImageSource(
                                      isCamera: true, isVideo: true)
                                  .then((value) {
                                appStore.setLoading(false);
                                CreateStoryScreen(
                                        cameraImage: value, isCameraVideo: true)
                                    .launch(context)
                                    .then((value) {
                                  if (value ?? false) {
                                    list.clear();
                              ...
                              await getMultipleImages().then((value) {
                                ...
                                if (value.isNotEmpty)
                                  CreateStoryScreen(mediaList: value)
                                      .launch(context)
                                      .then((value) {
                                    if (value ?? false) {
                                      list.clear();
                  ...
                  if (list.isNotEmpty && !appStore.showStoryLoader)
                    HorizontalList(
                      padding:
                          EdgeInsets.only(left: 0, top: 8, bottom: 8, right: 8),
                      spacing: 4,
                              ...
                              list[index].animationController!.addListener(() {
                                if (list[index]
                                  ...
                                  StoryPage(
                                    initialIndex: index,
                                    stories: list,
                                    initialStoryIndex: list[index]
                                        .items!
                                        .indexWhere((element) =>
                                            !element.seen.validate()),
                              ...
                              children: [
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    if (list.isNotEmpty &&
                                        !list[index].showBorder.validate() &&
                                        !list[index].seen.validate())
                                      Lottie.asset(
                                        story_loader,
                                        height: 60,
                                        width: 60,
                                        fit: BoxFit.cover,
                                        controller:
                                            list[index].animationController!,
                                      ),
                                  ],
                                ),
                                10.height,
