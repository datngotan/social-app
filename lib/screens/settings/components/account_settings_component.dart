...
import 'package:socialNetwork/screens/profile/screens/edit_profile_screen.dart';
import 'package:socialNetwork/screens/settings/screens/change_password_screen.dart';
import 'package:socialNetwork/screens/settings/screens/notification_settings.dart';
import 'package:socialNetwork/screens/settings/screens/profile_visibility_screen.dart';
import 'package:socialNetwork/screens/shop/screens/coupon_list_screen.dart';
      ...
      items: [
        if (appStore.showMemberShip)
          SettingItemWidget(
            ...
            leading: Image.asset(ic_ticket_star,
                height: 18,
                width: 18,
                color: context.primaryColor,
                fit: BoxFit.cover),
            trailing: Icon(Icons.arrow_forward_ios,
                color: appStore.isDarkMode ? bodyDark : bodyWhite, size: 16),
            onTap: () {
        ...
        SettingItemWidget(
          ...
          titleTextStyle: primaryTextStyle(
              color: appStore.isDarkMode ? bodyDark : bodyWhite),
          leading: Image.asset(ic_notification,
              height: 18,
              width: 18,
              color: context.primaryColor,
              fit: BoxFit.cover),
