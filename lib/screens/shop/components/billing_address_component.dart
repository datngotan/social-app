...
class BillingAddressComponent extends StatefulWidget {
  ...
  @override
  State<BillingAddressComponent> createState() =>
      _BillingAddressComponentState();
}
  ...
  void init() {
    ...
    if (widget.data!.country.validate().isNotEmpty) {
      selectedCountry = countriesList.firstWhere(
          (element) => element.code == widget.data!.country.validate());
      if (widget.data!.state.validate().isNotEmpty) {
        selectedState = selectedCountry!.states!.firstWhere(
            (element) => element.code == widget.data!.state.validate());
      }
    }
            ...
            child: DropdownButton<CountryModel>(
              ...
              items: countriesList
                ...
                return DropdownMenuItem<CountryModel>(
                  value: value,
                  child: Text(value.name.validate(),
