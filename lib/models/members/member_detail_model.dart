...
class MemberDetailModel {
  ...
  factory MemberDetailModel.fromJson(Map<String, dynamic> json) {
    return MemberDetailModel(
      ...
      highlightStory: json['highlight_story'] != null
          ? (json['highlight_story'] as List)
              .map((i) => HighlightStoriesModel.fromJson(i))
              .toList()
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.highlightStory != null) {
      data['highlight_story'] =
          this.highlightStory!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
