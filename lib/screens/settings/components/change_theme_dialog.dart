        ...
        children: [
            ...
            onChanged: (val) async {
              appStore.toggleDarkMode(
                  value: MediaQuery.of(context).platformBrightness ==
                      Brightness.dark);
              await setValue(
                  SharePreferencesKey.APP_THEME, AppThemeMode.ThemeModeSystem);
              await setValue(SharePreferencesKey.IS_DARK_MODE,
          ...
          RadioListTile(
            ...
            onChanged: (val) async {
              ...
              await setValue(
                  SharePreferencesKey.APP_THEME, AppThemeMode.ThemeModeDark);
          ...
          RadioListTile(
            ...
            onChanged: (val) async {
              ...
              await setValue(
                  SharePreferencesKey.APP_THEME, AppThemeMode.ThemeModeLight);
