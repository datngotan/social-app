...
import 'package:socialNetwork/screens/membership/screens/all_orders_screen.dart';
      ...
      return Column(
        ...
        children: [
          Container(
            ...
            child: Text(language.pastInvoices,
            ...
            children: [
              ...
              ...orderList.take(5).map((e) {
                return TableRow(
                  children: [
                    Text(
                      DateFormat(DATE_FORMAT_5)
                          .format(DateTime.parse(e.timestamp.validate())),
                    ...
                    Text(e.membershipName.validate(),
                            style: secondaryTextStyle())
                        .center()
                        .paddingSymmetric(vertical: 8),
                    Text('${pmpStore.pmpCurrency}${e.total.validate()}',
                            style: secondaryTextStyle())
                        .center()
                        .paddingSymmetric(vertical: 8),
                  ],
