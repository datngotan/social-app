...
import 'package:socialNetwork/screens/post/screens/video_post_screen.dart';
  ...
  void initState() {
    ...
    afterBuildCreated(() {
      indicatorAnimationController.value =
          IndicatorAnimationCommand(pause: true);
    });
                      ...
                      child: story.mediaType == MediaTypes.image
                          ? CachedNetworkImage(
                              ...
                              imageBuilder: (context, imageProvider) {
                                int duration = widget.stories[userIndex].items
                                    .validate()[storyIndex]
                                    .duration
                                    .validate()
                                    .toInt();
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            ...List<Color>.generate(
                                20,
                                (index) => Colors.grey.shade700
                                    .withAlpha(index * 10)).reversed,
                            Colors.transparent,
                          ],
                        ),
                      ),
                      padding:
                          const EdgeInsets.only(top: 46, left: 16, bottom: 20),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          cachedImage(
                                  user.categoryImage != null
                                      ? user.categoryImage
                                      : widget.avatarImage,
                                  fit: BoxFit.cover,
                                  height: 48,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(timeStampToDate(story.time.validate()),
                                  style:
                            ...
                            child: PopupMenuButton(
                              ...
                              onSelected: (val) async {
                                ...
                                showConfirmDialogCustom(
                                  ...
                                  title: val == 1
                                      ? language.trashConfirmationText
                                      : language.deleteStoryConfirmation,
                              ...
                              itemBuilder: (context) => <PopupMenuEntry>[
                                PopupMenuItem(
                                  value: 1,
                                  child: Text(language.moveToTrash,
                                ...
                                PopupMenuItem(
                                  value: 2,
                                  child: Text(language.deletePermanently,
                                      style:
                    ...
                    children: [
                      if (story.storyText.validate().isNotEmpty)
                        Container(
                          ...
                          child: Text(story.storyText.validate(),
                      ...
                      if (story.mediaType == MediaTypes.video)
                        TextButton(
                          onPressed: () {
                            VideoPostScreen(story.storyMedia.validate())
                                .launch(context);
                          },
                          child: Text(language.viewVideo,
                              style: boldTextStyle(color: Colors.white)),
                        ),
                    ],
                  ),
