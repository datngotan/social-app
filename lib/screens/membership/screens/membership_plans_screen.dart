...
import 'package:socialNetwork/screens/membership/screens/pmp_checkout_screen.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                UL(
                                  children: [
                                    getWidget(
                                        plan.bpLevelOptions!
                                            .pmproBpGroupCreation
                                            .validate(),
                                        language.groupCreation),
                                    getWidget(
                                        plan.bpLevelOptions!.pmproBpGroupsJoin
                                            .validate(),
                                        language.joinGroup),
                                    getWidget(
                                        plan.bpLevelOptions!
                                            .pmproBpGroupSingleViewing
                                            .validate(),
                                        language.viewGroupDetail),
                                    getWidget(
                                        plan.bpLevelOptions!
                                            .pmproBpGroupsPageViewing
                                            .validate(),
                                        language.viewGroups),
                                    getWidget(
                                        plan.bpLevelOptions!
                                            .pmproBpPrivateMessaging
                                            .validate(),
                                        language.privateMessages),
                                    getWidget(
                                        plan.bpLevelOptions!
                                            .pmproBpSendFriendRequest
                                            .validate(),
                                        language.sendFriendRequest),
                                    getWidget(
                                        plan.bpLevelOptions!
                                            .pmproBpMemberDirectory
                                            .validate(),
                                        language.viewMemberDirectory),
                                  ],
                                  symbolCrossAxisAlignment:
                                      CrossAxisAlignment.center,
                                  symbolColor: appStore.isDarkMode
                                      ? bodyDark
                                      : bodyWhite,
                            ...
                            AppButton(
                              ...
                              text: widget.selectedPlanId != plan.id
                                  ? language.selectAndProceed
                                  : language.yourPlan,
                              elevation: 0,
                              ...
                              onTap: () {
                                if (widget.selectedPlanId != plan.id)
                                  PmpCheckoutScreen(selectedPlan: plan)
                                      .launch(context);
                              },
                            ).paddingAll(16)
                          ],
