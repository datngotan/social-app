...
class PmpOrderDetailScreen extends StatelessWidget {
  ...
  PmpOrderDetailScreen(
      {this.isFromCheckOutScreen = false, required this.orderDetail});
    ...
    return WillPopScope(
      ...
      child: AppScaffold(
        ...
        child: Column(
          ...
          children: [
            Text('${language.invoiceId}: #${orderDetail.code}',
                style: boldTextStyle()),
            16.height,
            Container(
              width: context.width(),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Divider(height: 20),
                  Text('${language.plan}: ${orderDetail.membershipName}',
                      style: primaryTextStyle()),
                  12.height,
                  Text(
                      '${language.dateCreated}: ${DateFormat(DATE_FORMAT_5).format(DateTime.parse(orderDetail.timestamp.validate()))}',
                      style: primaryTextStyle()),
                  12.height,
                  Text('${language.status}: ${language.paid}',
                      style: primaryTextStyle()),
                  12.height,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  12.height,
                  Text(
                      '${language.payVia}: ${orderDetail.cardtype} ending in ${orderDetail.accountnumber.validate().substring(orderDetail.accountnumber.validate().length - 4)}',
                      style: primaryTextStyle()),
                  12.height,
                  if (orderDetail.expirationmonth.validate().isNotEmpty &&
                      orderDetail.expirationyear.validate().isNotEmpty)
                    Text(
                  ...
                  Text(
                      '${language.totalAmount}: ${pmpStore.pmpCurrency}${orderDetail.total}',
                      style: primaryTextStyle()),
                  12.height,
                ],
              ),
