          ...
          Row(
            ...
            children: [
                ...
                onTap: () async {
                  ifNotTester(() async {
                    ...
                    await acceptGroupInvite(
                            id: widget.hasInvite.validate().toString())
                        .then((value) async {
              ...
              AppButton(
                ...
                textStyle:
                    secondaryTextStyle(color: context.primaryColor, size: 14),
                onTap: () async {
                  ifNotTester(() async {
                    appStore.setLoading(true);
                    await rejectGroupInvite(id: widget.hasInvite.validate())
                        .then((value) async {
                      widget.callback?.call();
                    }).catchError((e) {
                      appStore.setLoading(false);
          ...
          ifNotTester(() {
            if (widget.isRequestSent.validate() == 0) {
              ...
              rejectGroupMembershipRequest(
                      requestId: widget.isRequestSent.validate())
                  .then((value) {
                widget.callback?.call();
              }).catchError((e) {
                toast(e.toString(), print: true);
