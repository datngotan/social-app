...
import 'package:socialNetwork/screens/profile/components/expansion_body.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void update() {
    ifNotTester(() async {
      ...
      if (cover != null) {
        appStore.setLoading(true);
        await attachMemberImage(
                id: appStore.loginUserId, image: cover, isCover: true)
            .then((value) {
                                ...
                                if (!appStore.isLoading) {
                                  ...
                                  if (file != null) {
                                    if (file == FileTypes.CANCEL) {
                                      ifNotTester(() async {
                                        appStore.setLoading(true);
                                        await deleteMemberCoverImage(
                                                id: appStore.loginUserId
                                                    .toInt())
                                            .then((value) {
                                          toast(language
