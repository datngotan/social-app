        ...
        child: StoryPageView(
          onStoryIndexChanged: (int newStoryIndex) async {
            ...
            if (widget.stories[userIndex].items.validate().isNotEmpty) {
              if (widget.stories[userIndex].items.validate().length >
                  newStoryIndex) {
                if (widget.stories[userIndex].items
                        .validate()[newStoryIndex]
                        .duration !=
                    null) {
                  duration = widget.stories[userIndex].items
                      .validate()[newStoryIndex]
                      .duration
                      .validate()
                      .toInt();
          ...
          itemBuilder: (context, pageIndex, storyIndex) {
            ...
            if (!widget.stories[userIndex].items!
                ...
                .validate())
              viewStory(
                      storyId: widget.stories[userIndex].items![storyIndex].id
                          .validate())
                  .then((value) {
