...
class CreateGroupStepSecond extends StatefulWidget {
  ...
  const CreateGroupStepSecond(
      {Key? key,
      this.onNextPage,
      this.isAPartOfSteps = true,
      this.groupInviteStatus,
...
class _CreateGroupStepSecondState extends State<CreateGroupStepSecond> {
  ...
  Future<void> editGroup() async {
    ifNotTester(() async {
      ...
      await editGroupSettings(
              groupId: groupId,
              enableGallery: isGalleryEnabled.substring(14),
              inviteStatus: groupInvitations.toString().substring(17))
          .then((value) {
              ...
              child: Form(
                child: Column(
                  ...
                  children: [
                    ...
                    16.height,
                    Text(language.groupInvites,
                        style: primaryTextStyle(
                            color: appStore.isDarkMode ? bodyDark : bodyWhite,
                            size: 18)),
                    16.height,
                    Text(language.groupInvitationsSubtitle,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(language.allGroupMembers, style: boldTextStyle())
                            .paddingTop(12),
                      ],
                    ).onTap(() {
                      if (!appStore.isLoading)
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(language.groupAdminsAndModsOnly,
                                style: boldTextStyle())
                            .paddingTop(12),
                      ],
                    ).onTap(() {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(language.groupAdminsOnly, style: boldTextStyle())
                            .paddingTop(12),
                      ],
                    ).onTap(() {
                      if (!appStore.isLoading)
                    ...
                    8.height,
                    Text(language.enableGallery,
                        style: primaryTextStyle(
                            color: appStore.isDarkMode ? bodyDark : bodyWhite,
                            size: 18)),
                    16.height,
                    Text(language.enableGallerySubtitle,
                        style: secondaryTextStyle()),
                    16.height,
                    Row(
                      children: [
                        ...
                        Text(language.enableGalleryCheckBoxText,
                                style: secondaryTextStyle())
                            .onTap(() {
                          enableGallery = !enableGallery;
                          setState(() {});
