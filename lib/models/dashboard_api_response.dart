...
class DashboardAPIResponse {
  ...
  factory DashboardAPIResponse.fromJson(Map<String, dynamic> json) {
    return DashboardAPIResponse(
      ...
      visibilities: json['visibilities'] != null
          ? (json['visibilities'] as List)
              .map((i) => VisibilityOptions.fromJson(i))
              .toList()
          : null,
      accountPrivacyVisibility: json['account_privacy_visibility'] != null
          ? (json['account_privacy_visibility'] as List)
              .map((i) => VisibilityOptions.fromJson(i))
              .toList()
          : null,
      reportTypes: json['report_types'] != null
          ? (json['report_types'] as List)
              .map((i) => ReportType.fromJson(i))
              .toList()
          : null,
      storyAllowedTypes: json['story_allowed_types'] != null
          ? new List<String>.from(json['story_allowed_types'])
          : null,
      suggestedUser: json['suggested_user'] != null
          ? (json['suggested_user'] as List)
      ...
      storyActions: json['story_actions'] != null
          ? (json['story_actions'] as List)
              .map((i) => StoryActions.fromJson(i))
              .toList()
          : null,
      ...
      suggestedGroups: json['suggested_groups'] != null
          ? (json['suggested_groups'] as List)
              .map((i) => SuggestedGroup.fromJson(i))
              .toList()
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.visibilities != null) {
      data['account_privacy_visibility'] =
          this.accountPrivacyVisibility!.map((v) => v.toJson()).toList();
    }
    ...
    if (this.storyActions != null) {
      data['story_actions'] =
          this.storyActions!.map((v) => v.toJson()).toList();
    }
