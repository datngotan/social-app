...
import 'package:socialNetwork/screens/blog/components/edit_blog_comment_component.dart';
...
class BlogCommentComponent extends StatelessWidget {
  ...
  BlogCommentComponent(
      {required this.comment, required this.onDelete, required this.onUpdate});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(comment.author_name.validate(),
                      style: secondaryTextStyle()),
                  4.height,
                  Text(convertToAgo(comment.date.validate()),
                      style: secondaryTextStyle()),
                ],
              ).expand(),
          ...
          16.height,
          Text(parseHtmlString(comment.content!.rendered.validate()),
