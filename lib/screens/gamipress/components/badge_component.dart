...
import 'package:socialNetwork/screens/gamipress/screens/earned_badges_screen.dart';
    ...
    if (badgeList.isEmpty)
      ...
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text("${language.earnedBadges}: $achievementCount",
            ...
            AnimatedListView(
              ...
              itemBuilder: (ctx, index) {
                ...
                return ListTile(
                  ...
                  title: Text(badge.name.validate(),
                      style: secondaryTextStyle(size: 16)),
                  leading: cachedImage(badge.image.validate(),
