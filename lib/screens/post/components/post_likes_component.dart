              ...
              (e) {
                return Container(
                  ...
                  margin: EdgeInsets.only(
                      left: 18 * postLikeList.validate().indexOf(e).toDouble()),
                  child: cachedImage(
                    postLikeList
                        .validate()[postLikeList.validate().indexOf(e)]
                        .userAvatar
                        .validate(),
                    fit: BoxFit.cover,
              ...
              children: <TextSpan>[
                ...
                if (postLikeList.length > 1)
                  TextSpan(
                      text: ' ${language.and} ',
                      style:
                          secondaryTextStyle(size: 12, fontFamily: fontFamily)),
                if (postLikeList.length > 1)
                  TextSpan(
                      text: '${postLikeCount - 1} ${language.others}',
                      style: boldTextStyle(size: 12, fontFamily: fontFamily)),
              ],
            ),
          ).paddingAll(8).onTap(() {
