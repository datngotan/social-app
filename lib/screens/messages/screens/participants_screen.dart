...
class _ParticipantsScreenState extends State<ParticipantsScreen> {
  ...
  Future<void> allowOthersToInvite() async {
    ...
    await allowOtherToInviteMembers(
            canInvite: allowOtherToInvite, threadId: widget.threadId.validate())
        .then((value) {
      isRefresh = true;
      appStore.setLoading(false);
                        ...
                        Column(
                          children: [
                            ...
                            CheckboxListTile(
                              ...
                              subtitle: Text(language.enableInviteConversation,
