...
class PriceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (!salePrice.validate().contains('0.00')) {
      return RichText(
        text: TextSpan(
          ...
          style: secondaryTextStyle(
              decoration: TextDecoration.lineThrough, fontFamily: fontFamily),
          children: <TextSpan>[
            TextSpan(
      ...
      return Text('Free',
          style: boldTextStyle(
              decoration: TextDecoration.none, color: appGreenColor));
    } else {
      return Text('${price.validate()}',
          style: boldTextStyle(
              decoration: TextDecoration.none, color: context.primaryColor));
    }
  }
}
