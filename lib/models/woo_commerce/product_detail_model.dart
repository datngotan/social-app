...
import 'package:socialNetwork/models/woo_commerce/tags_model.dart';
  ...
  factory ProductDetailModel.fromJson(Map<String, dynamic> json) {
    return ProductDetailModel(
      ...
      relatedIds: json['related_ids'] != null
          ...
          : null,
      relatedProductList: json['related_id'] != null
          ? (json['related_id'] as List)
              .map((i) => RelatedProductModel.fromJson(i))
              .toList()
          : null,
      ...
      upsellId: json['upsell_id'] != null
          ? (json['upsell_id'] as List).map((i) => i.fromJson(i)).toList()
          : null,
