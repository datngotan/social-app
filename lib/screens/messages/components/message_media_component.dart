...
import 'package:socialNetwork/screens/messages/screens/view_message_media_screen.dart';
    ...
    return InkWell(
      ...
      child: Wrap(
        ...
        children: widget.files.validate().take(2).map((e) {
          String type = e.mimeType
              .validate()
              .substring(0, e.mimeType.validate().indexOf('/'));

          return Stack(
            children: [
              if (type == MediaTypes.image)
                cachedImage(e.thumb, height: 80, width: 80, fit: BoxFit.cover)
              ...
              if (widget.files.validate().indexOf(e) == 1 &&
                ...
                Container(
                  ...
                  child: Text('+ ${widget.files.validate().length - 2}',
