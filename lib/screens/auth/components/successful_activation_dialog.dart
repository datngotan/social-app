...
class SuccessfulActivationDialog extends StatefulWidget {
  ...
  @override
  State<SuccessfulActivationDialog> createState() =>
      _SuccessfulActivationDialogState();
}

class _SuccessfulActivationDialogState
    extends State<SuccessfulActivationDialog> {
  @override
  void initState() {
    super.initState();
  }
      ...
      content: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(language.yourAccountIsNowActive,
