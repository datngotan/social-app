  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) {
    return ProductModel(
      ...
      crossSellIds: json['cross_sell_ids'] != null
          ? (json['cross_sell_ids'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      ...
      dateOnSaleFrom:
          json['date_on_sale_from'] != null ? json['date_on_sale_from'] : null,
      dateOnSaleFromGmt: json['date_on_sale_from_gmt'] != null
          ? json['date_on_sale_from_gmt']
          : null,
      dateOnSaleTo:
          json['date_on_sale_to'] != null ? json['date_on_sale_to'] : null,
      ...
      downloads: json['downloads'] != null
          ? (json['downloads'] as List)
              .map((i) => Downloads.fromJson(i))
              .toList()
          : null,
      externalUrl: json['external_url'],
      featured: json['featured'],
      groupedProducts: json['grouped_products'] != null
          ? new List<int>.from(json['grouped_products'])
          : null,
      ...
      images: json['images'] != null
          ...
          : null,
      lowStockAmount:
          json['low_stock_amount'] != null ? json['low_stock_amount'] : null,
      ...
      tags: json['tags'] != null
          ? (json['tags'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      ...
      upsellIds: json['upsell_ids'] != null
          ? (json['upsell_ids'] as List).map((i) => i.fromJson(i)).toList()
          : null,
