...
import 'package:socialNetwork/screens/lms/components/write_course_review.dart';
...
class ReviewTabComponent extends StatefulWidget {
  ...
  const ReviewTabComponent({Key? key, required this.courseId})
      : super(key: key);
  ...
  Future<void> getReview() async {
    ...
    getCourseReviews(courseId: widget.courseId).then((value) {
      ...
      if (value.data!.items != null) {
        value.data!.items!.keys
            .map((e) => value.data!.items![e])
            .toList()
            .forEach((element) {
        ...
        if (isFetched && !showLoading)
          Column(
            ...
            children: [
              if (snap.message.validate().isNotEmpty)
                Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border(
                        left: BorderSide(color: appGreenColor, width: 2)),
                  ),
                  padding: EdgeInsets.all(12),
                  margin: EdgeInsets.all(16),
                  child: Text(snap.message.validate(),
                      style: primaryTextStyle(color: appGreenColor)),
                ),
              if (snap.data != null)
                Row(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              language.total +
                                  ': ' +
                                  snap.data!.total.validate().toString(),
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: LinearProgressIndicator(
                                  ...
                                  value:
                                      e.percent_float.validate().round() / 100,
              ...
              if (snap.data!.reviews != null &&
                  snap.data!.reviews!.reviews.validate().isNotEmpty)
              ...
              if (snap.data!.reviews != null &&
                ...
                ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    Review review =
                        snap.data!.reviews!.reviews.validate()[index];
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(review.display_name.validate(),
                                  style: boldTextStyle()),
                              RatingBarWidget(
                                onRatingChanged: (x) {
                                  //
                          ...
                          8.height,
                          Text(review.title.validate(),
                              style: secondaryTextStyle()),
                          8.height,
                          Text(parseHtmlString(review.content.validate()),
                              style: primaryTextStyle()),
                        ],
                      ),
                    );
