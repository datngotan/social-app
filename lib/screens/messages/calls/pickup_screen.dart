                  ...
                  RawMaterialButton(
                    onPressed: () async {
                      if (appStore.isWebsocketEnable == 1 &&
                        ...
                        String messageTwo =
                            '42["${SocketEvents.mediaEvent}",{"event":"${SocketEvents.selfReject}","thread_id":${widget.callModel!.threadId},"to":${appStore.loginUserId}}]';
                      ...
                      if (isAndroid) {
                        if (await Permissions
                          ...
                          isPickUpScreenLaunched = false;
                          AgoraVideoCallScreen(callModel: widget.callModel!)
                              .launch(context)
                              .then((value) {
                            finish(context);
                          });
