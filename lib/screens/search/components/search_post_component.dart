            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    cachedImage(
                      data.userAvatar!.full.validate() != 'false'
                          ? data.userAvatar!.full.validate()
                          : '',
                      height: 40,
                      width: 40,
                      fit: BoxFit.cover,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        4.height,
                        Text(convertToAgo(data.date.validate()),
                  ...
                  if (data.userId.validate() != 0) {
                    MemberProfileScreen(memberId: data.userId.validate())
                        .launch(context);
                  } else {
                    toast(language.canNotViewThisUser);
                  }
                }, borderRadius: radius(8)),
                if (data.content!.rendered.validate().isNotEmpty)
                  Text(
                          parseHtmlString(
                              data.content!.rendered..validateAndFilter()),
                ...
                InkWell(
                  ...
                  onTap: () {
                    SinglePostScreen(postId: data.id.validate())
                        .launch(context);
                  },
                ).center().paddingTop(
                    data.content!.rendered.validate().isNotEmpty ? 0 : 8),
              ],
            ),
          );
        },
