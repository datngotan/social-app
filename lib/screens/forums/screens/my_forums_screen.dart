...
import 'package:socialNetwork/screens/forums/components/favourite_topics_component.dart';
import 'package:socialNetwork/screens/forums/components/forum_replies_component.dart';
import 'package:socialNetwork/screens/forums/components/forum_subscription_component.dart';
import 'package:socialNetwork/screens/forums/components/user_topic_component.dart';
import 'package:socialNetwork/screens/forums/components/forums_engagement_component.dart';
        ...
        children: [
          HorizontalList(
            ...
            itemBuilder: (context, index) {
              return AppButton(
                shapeBorder:
                    RoundedRectangleBorder(borderRadius: radius(commonRadius)),
                text: tabList[index],
