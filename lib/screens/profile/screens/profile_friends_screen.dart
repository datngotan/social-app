...
import 'package:socialNetwork/screens/profile/components/friends_component.dart';
import 'package:socialNetwork/screens/profile/components/request_sent_component.dart';
import 'package:socialNetwork/screens/profile/components/requests_received_component.dart';
            ...
            children: [
              Container(
                ...
                child: TabBar(
                  ...
                  tabs: [
                    FittedBox(
                        child: Text(language.friends,
                                style: boldTextStyle(color: Colors.white))
                            .paddingSymmetric(vertical: 12)),
                    FittedBox(
                        child: Text(language.sent,
                                style: boldTextStyle(color: Colors.white))
                            .paddingSymmetric(vertical: 12)),
                    FittedBox(
