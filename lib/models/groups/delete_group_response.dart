import 'package:socialNetwork/models/groups/admin.dart';
  ...
  factory Previous.fromJson(Map<String, dynamic> json) {
    return Previous(
      admins: json['admins'] != null
          ? (json['admins'] as List).map((i) => Admin.fromJson(i)).toList()
          : null,
      ...
      link: json['link'],
      mods: json['mods'] != null
          ? (json['mods'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      name: json['name'],
      ...
      types: json['types'] != null
          ? (json['types'] as List).map((i) => i.fromJson(i)).toList()
          : null,
    );
  }
