...
import 'package:socialNetwork/screens/lms/components/price_widget.dart';
import 'package:socialNetwork/screens/lms/screens/course_detail_screen.dart';
          ...
          children: [
            cachedImage(
              ...
              fit: BoxFit.cover,
                ...
                topLeft: commonRadius.toInt(), topRight: commonRadius.toInt()),
            20.height,
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                      ...
                      children: [
                        if (course.categories.validate().isNotEmpty)
                          InkWell(
                            ...
                            child: Text(
                              parseHtmlString(course.categories
                                  .validate()
                                  .first
                                  .name
                                  .validate()),
                    ...
                    PriceWidgetLms(
                        originPrice: course.origin_price_rendered,
                        salePrice: course.sale_price.validate(),
                        price: course.price_rendered.validate()),
                  ],
                ),
                8.height,
                ...
                Wrap(
                  ...
                  children: [
                    Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        cachedImage(ic_profile,
                            height: 14,
                            width: 16,
                            fit: BoxFit.cover,
                            color: context.iconColor),
                        4.width,
                        Text(course.instructor!.name.validate(),
                            style: secondaryTextStyle()),
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        ...
                        4.width,
                        Text(
                            '${course.count_students.validate().toString()} ${language.students}',
                            style: secondaryTextStyle()),
                      ],
                    ),
                    Row(
