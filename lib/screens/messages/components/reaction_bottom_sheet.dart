      ...
      children: [
            ...
            children: [
              ...
              ...widget.meta!.reactions.validate().map((a) {
                int iconIndex = emojiList.indexWhere((e) =>
                    e.skins.validate().first.unified.validate() ==
                    a.reaction.validate());
                ...
                return Row(
                  ...
                  children: [
                    ...
                    4.width,
                    Text(a.users.validate().length.toString(),
        ...
        Column(
          ...
          children: widget.meta!.reactions!.map((e) {
            int iconIndex = emojiList.indexWhere((x) =>
                x.skins.validate().first.unified.validate() ==
                e.reaction.validate());
            String reaction =
                emojiList[iconIndex].skins.validate().first.native.validate();

            return Column(
              mainAxisSize: MainAxisSize.min,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: e.users.validate().map((element) {
                MessagesUsers user = widget.users
                    .firstWhere((user) => user.userId == element.validate());
                ...
                return Row(
                  children: [
                    ...
                    16.width,
                    Text(user.name.validate(), style: primaryTextStyle())
                        .expand(),
                    Text(parser.emojify(reaction),
