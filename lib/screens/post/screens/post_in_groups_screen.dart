...
import 'package:socialNetwork/screens/groups/components/initial_no_group_component.dart';
...
class _PostInGroupsScreenState extends State<PostInGroupsScreen> {
  ...
  Future<List<GroupModel>> getGroups() async {
    ...
    await getGroupList(groupType: GroupRequestType.myGroup, page: mPage)
        .then((value) {
          ...
          onPressed: () {
            if (selectedIndex != null) {
              finish(
                context,
                PostInListModel(
                    title: groupList[selectedIndex.validate()].name,
                    id: groupList[selectedIndex.validate()].id),
              );
            } else {
              finish(context);
            }
          },
          child: Text(language.done.capitalizeFirstLetter(),
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: TextIcon(
                        prefix: cachedImage(data.groupAvatarImage.validate(),
