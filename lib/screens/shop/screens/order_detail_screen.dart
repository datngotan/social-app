...
import 'package:socialNetwork/screens/shop/components/cancel_order_bottomsheet.dart';
                      ...
                      children: [
                        ListView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            LineItem item =
                                widget.orderDetails.lineItems.validate()[index];
                            ...
                            return Row(
                              ...
                              ProductDetailScreen(id: item.productId.validate())
                                  .launch(context);
                            },
                        ...
                        if (widget.orderDetails.couponLines
                            .validate()
                            .isNotEmpty) ...[
                          Divider(height: 32),
                          Text(language.appliedCoupons,
                              style: boldTextStyle(size: 14)),
                          8.height,
                          ListView.builder(
                            shrinkWrap: true,
                            physics: NeverScrollableScrollPhysics(),
                            itemCount: widget.orderDetails.couponLines
                                .validate()
                                .length,
                            itemBuilder: (ctx, index) {
                              OrderCouponModel coupon = widget
                              ...
                              return Row(
                                ...
                                children: [
                                  Text('${language.couponCode}: ${coupon.code}',
                                      style: secondaryTextStyle()),
                                  PriceWidget(
                                      price: coupon.discount.validate()),
                                ],
                              );
                            },
                          ),
                        ...
                        if (widget.orderDetails.discountTotal.validate() !=
                            '0.00')
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('${language.discount}:',
                                  style: boldTextStyle()),
                              PriceWidget(
                                  price: widget.orderDetails.discountTotal
                                      .validate()),
                            ],
                          ),
                        Row(
