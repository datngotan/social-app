        ...
        children: [
          Stack(
            ...
            children: [
              Row(
                children: [
                  Image.asset(ic_two_user,
                      height: 16, width: 16, fit: BoxFit.cover),
                  8.width,
                  Text(
                          widget.topic.createdByName
                              .validate()
                    ...
                    MemberProfileScreen(
                            memberId:
                                widget.topic.createdById.validate().toInt())
                        .launch(context);
                  },
                          splashColor: Colors.transparent,
                          highlightColor: Colors.transparent),
                  20.width,
                  Image.asset(ic_folder,
                          height: 16, width: 16, fit: BoxFit.cover)
                      .visible(widget.showForums),
              ...
              if (widget.isFavTab)
                Image.asset(ic_heart_filled,
                        height: 16, width: 16, fit: BoxFit.fill)
                    .onTap(() {
                  ifNotTester(() {
                    widget.callback!.call();
                    favoriteTopic(topicId: widget.topic.id.validate())
                        .then((value) {
                      log('Success');
                    }).catchError(onError);
                  });
          ...
          Text(
              parseHtmlString(
                  widget.topic.title.validate().validateAndFilter()),
              style: boldTextStyle()),
          Divider(height: 30),
          Row(
            ...
            children: [
              Column(
                children: [
                  ...
                  4.height,
                  Text(widget.topic.voicesCount.validate().toString(),
                      style: secondaryTextStyle()),
                ],
              ),
              Column(
                children: [
                  ...
                  4.height,
                  Text(widget.topic.postCount.validate().toString(),
                      style: secondaryTextStyle()),
                ],
              ),
              Column(
                children: [
                  ...
                  Stack(
                    children:
                        widget.topic.freshness.validate().take(3).map((e) {
                      return Container(
                        width: 20,
                        height: 20,
                        margin: EdgeInsets.only(
                            left: 10 *
                                widget.topic.freshness
                                    .validate()
                                    .indexOf(e)
                                    .toDouble()),
                        child: cachedImage(
                          widget.topic.freshness
                              .validate()[
                                  widget.topic.freshness.validate().indexOf(e)]
                              .userProfileImage
                              .validate(),
                          fit: BoxFit.cover,
