...
import 'package:socialNetwork/screens/groups/components/create_group_step_one.dart';
import 'package:socialNetwork/screens/groups/screens/create_group_screen.dart';
...
class _EditGroupScreenState extends State<EditGroupScreen> {
  ...
  Future<void> init() async {
    ...
    coverImage = group.groupCoverImage.validate().isNotEmpty
        ? group.groupCoverImage.validate()
        : AppImages.profileBackgroundImage;
    if (group.groupAvatarImage.validate().isNotEmpty)
                  ...
                  if (!appStore.isLoading)
                    showConfirmDialogCustom(
                      ...
                      onAccept: (c) {
                        ifNotTester(() {
                          appStore.setLoading(true);
                          deleteGroup(id: widget.groupId.toString().validate())
                              .then((value) {
                            finish(context);
                            finish(context, true);
                          }).catchError((e) {
                  ...
                  children: [
                              ...
                              onTap: () async {
                                ...
                                if (file != null) {
                                  if (file == FileTypes.CANCEL) {
                                    ifNotTester(() async {
                                      appStore.setLoading(true);
                                      await deleteGroupCoverImage(
                                              id: widget.groupId.validate())
                                          .then((value) {
                                        toast(language
                                            .coverImageRemovedSuccessfully);
                                        isChange = true;
                                        init();
                                      }).catchError((e) {
                                        appStore.setLoading(false);
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(language.thisIsAPublic, style: boldTextStyle())
                                .paddingTop(12),
                            6.height,
                            Column(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(language.thisIsAHidden, style: boldTextStyle())
                                .paddingTop(12),
                            6.height,
                            Column(
                    ...
                    Row(
                      children: [
                        ...
                        Text(language.wantGroupAsForum,
                      ...
                      ifNotTester(() async {
                        if (nameCont.text.isNotEmpty && detailsChanged) {
                          ...
                          await updateGroup(
                              ...
                              .then((value) {
                            toast(language.groupUpdatedSuccessfully,
                                print: true);
                          }).catchError((e) {
                            toast(e.toString(), print: true);
                          });
