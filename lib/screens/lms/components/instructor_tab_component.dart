...
import 'package:socialNetwork/models/lms/lms_common_models/instrustor_model.dart';
  ...
  Widget build(BuildContext context) {
    if (instructor != null) {
      return GestureDetector(
        onTap: () {
          MemberProfileScreen(memberId: instructor!.id.validate())
              .launch(context);
        },
        child: Container(
          ...
          child: Row(
            ...
            children: [
              SnapHelperWidget(
                future:
                    getMemberAvatarImage(memberId: instructor!.id.validate()),
                      ...
                      children: [
                        if (instructor!.social!.facebook.validate().isNotEmpty)
                          InkWell(
                            ...
                            onTap: () {
                              openWebPage(context,
                                  url: instructor!.social!.facebook.validate());
                            },
                            child: Image.asset(ic_facebook,
                                height: 22, width: 22, fit: BoxFit.fill),
                          ),
                        if (instructor!.social!.twitter.validate().isNotEmpty)
                          InkWell(
                            ...
                            onTap: () {
                              openWebPage(context,
                                  url: instructor!.social!.twitter.validate());
                            },
                        ...
                        if (instructor!.social!.youtube.validate().isNotEmpty)
                          InkWell(
                            ...
                            onTap: () {
                              openWebPage(context,
                                  url: instructor!.social!.youtube.validate());
                            },
                            child: Image.asset(ic_youtube,
                                    height: 22, width: 22, fit: BoxFit.fill)
                        ...
                        if (instructor!.social!.linkedin.validate().isNotEmpty)
                          InkWell(
                            ...
                            onTap: () {
                              openWebPage(context,
                                  url: instructor!.social!.linkedin.validate());
                            },
                            child: Image.asset(ic_linkedIn,
                                height: 22, width: 22, fit: BoxFit.fill),
                          ),
                      ],
                    ),
