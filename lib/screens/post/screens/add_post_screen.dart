...
import 'package:socialNetwork/models/common_models/post_mdeia_model.dart';
...
import 'package:socialNetwork/models/posts/post_in_list_model.dart';
import 'package:socialNetwork/models/posts/post_model.dart';
import 'package:socialNetwork/network/rest_apis.dart';
import 'package:socialNetwork/screens/post/components/add_post_media_component.dart';
import 'package:socialNetwork/screens/post/components/edit_post_media_component.dart';
import 'package:flutter_mentions/flutter_mentions.dart';
import 'package:socialNetwork/screens/post/components/show_selected_media_component.dart';
import 'package:socialNetwork/screens/post/screens/post_in_groups_screen.dart';
...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Future<void> init() async {
    if (widget.post != null) {
      if (mediaTypeList.isNotEmpty &&
          (widget.post!.mediaType != null &&
              widget.post!.mediaType.validate().isNotEmpty)) {
      ...
      if (postContentTextKey.currentState != null)
        postContentTextKey.currentState!.controller!.text = parseHtmlString(
            widget.post!.content.validate().replaceAll('</br>', '\n'));
      setState(() {});
    }
  }
              ...
              if (!appStore.isLoading) {
                ifNotTester(() async {
                  if (mediaList.isEmpty &&
                      postContentTextKey
                          .currentState!.controller!.text.isEmpty &&
                      gif == null) {
                    ...
                    await uploadPost(
                      ...
                      if (widget.parentPostId.validate().isEmpty)
