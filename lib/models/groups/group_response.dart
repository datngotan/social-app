...
import 'package:socialNetwork/models/common_models/description.dart';
import 'package:socialNetwork/models/common_models/links.dart';
...
class GroupResponse {
  ...
  factory GroupResponse.fromJson(Map<String, dynamic> json) {
    return GroupResponse(
      ...
      id: json['id'],
      lastActivity:
          json['last_activity'] != null ? json['last_activity'] : null,
      lastActivityDiff: json['last_activity_diff'] != null
          ? json['last_activity_diff']
          : null,
      link: json['link'],
      name: json['name'],
      ...
      slug: json['slug'],
      status: json['status'],
      totalMemberCount: json['total_member_count'] != null
