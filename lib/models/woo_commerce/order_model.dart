...
import 'package:socialNetwork/models/woo_commerce/shipping_lines.dart';
    ...
    return OrderModel(
      ...
      couponLines: json['coupon_lines'] != null
          ? (json['coupon_lines'] as List)
              .map((i) => OrderCouponModel.fromJson(i))
              .toList()
          : null,
      ...
      feeLines: json['fee_lines'] != null
          ? (json['fee_lines'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      id: json['id'],
      ...
      refunds: json['refunds'] != null
          ? (json['refunds'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      ...
      taxLines: json['tax_lines'] != null
          ? (json['tax_lines'] as List).map((i) => i.fromJson(i)).toList()
          : null,
      total: json['total'],
