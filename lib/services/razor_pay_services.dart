...
import 'package:socialNetwork/models/payment/razorpay_model.dart';
    ...
    generateOrder(request).then((order) async {
      await getMembershipLevelForUser(
        ...
        if (value != null) {
          ...
          PmpOrderDetailScreen(isFromCheckOutScreen: true, orderDetail: order)
              .launch(context);
        }
      }).catchError((e) {
        appStore.setLoading(false);
