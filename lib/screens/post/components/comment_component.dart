...
import 'package:socialNetwork/screens/post/screens/comment_reply_screen.dart';
    ...
    return Column(
      ...
      children: [
        ...
        (widget.comment.hasMentions == 1 ||
                ...
                widget.comment.content.validate().contains('</br>'))
            ? HtmlWidget(
                postContent: widget.comment.content.validateAndFilter())
            : Text(parseHtmlString(widget.comment.content.validateAndFilter()),
          ...
          children: [
            Row(
              children: [
                ...
                if (widget.comment.userId == appStore.loginUserId &&
                    widget.comment.id != null)
                  IconButton(
                    onPressed: () {
                      if (!appStore.isLoading) {
