...
class ThreeReactionComponent extends StatefulWidget {
  ...
  const ThreeReactionComponent(
      {required this.postReactionCount,
      required this.postReactionList,
      required this.id,
            ...
            children: [
                      ...
                      margin: EdgeInsets.only(
                          left: 14 *
                              widget.postReactionList
                                  .indexOf(reaction)
                                  .toDouble()),
                      child: cachedImage(reaction.icon.validate(),
                              fit: BoxFit.cover)
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text: widget.postReactionList.first.user!.displayName
                                  .validate() ==
                              appStore.loginUserId
                          ? ' ${language.you} '
                          : ' ${widget.postReactionList.first.user!.displayName}',
                      style: boldTextStyle(size: 12, fontFamily: fontFamily),
                    ),
                    if (widget.postReactionList.length > 1)
                      TextSpan(
                          text: ' ${language.and} ',
                    ...
                    if (widget.postReactionList.length > 1)
                      TextSpan(
                          text:
                              '${widget.postReactionCount - 1} ${language.others}',
                          style:
