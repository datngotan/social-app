import 'package:socialNetwork/models/messages/chat_background_model.dart';
...
class Threads {
  ...
  Threads.fromJson(dynamic json) {
    ...
    participants =
        json['participants'] != null ? json['participants'].cast<int>() : [];
    ...
    mentions = json['mentions'] != null
        ? (json['mentions'] as List).map((i) => i.fromJson(i)).toList()
        : null;
    unread = json['unread'];
    secretKey = json['secret_key'];
    chatBackground = json['chat_background'] != null
        ? ChatBackgroundModel.fromJson(json['chat_background'])
        : null;
  }
