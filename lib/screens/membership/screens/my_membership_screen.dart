...
import 'package:socialNetwork/screens/membership/screens/cancel_membership_screen.dart';
import 'package:socialNetwork/screens/membership/components/past_invoices_component.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.all(16),
              child: Text(language.myMemberships,
                  style: boldTextStyle(color: context.primaryColor)),
            ),
                      ...
                      children: [
                        if (membership!.isExpired.validate())
                          appButton(
                            ...
                            context: context,
                            onTap: () {
                              PmpCheckoutScreen(selectedPlan: membership!)
                                  .launch(context);
                            },
                        ...
                        appButton(
                          ...
                          onTap: () {
                            MembershipPlansScreen(
                                    selectedPlanId: membership!.id.validate())
                                .launch(context);
                          },
                        ...
                        appButton(
                          ...
                          onTap: () {
                            CancelMembershipScreen(
                                    currentLevelId: membership!.id.validate())
                                .launch(context)
                                .then((value) {
                              if (value ?? false) {
                                getMembership();
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(language.viewAllMembershipOptions,
