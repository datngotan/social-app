                  ...
                  if (snap.data.validate().isEmpty) {
                    ...
                    return AnimatedListView(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        DateTime input = DateFormat(DATE_FORMAT_2)
                            .parse(coupon.dateExpires.validate(), true);
                              ...
                              Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Text(
                                          '\$${coupon.amount.toDouble().round()} ${language.off}',
                                          style: boldTextStyle(
                                              size: 18,
                                  ...
                                  Text(coupon.description.validate(),
                                      style: primaryTextStyle()),
                                  8.height,
                                  Text(
                                      '${language.expiresOn} ${formatDate(coupon.dateExpires.validate())}',
                              ...
                              if (isExpired)
                                Container(
                                  color: appStore.isDarkMode
                                      ? bodyDark.withOpacity(0.5)
                                      : bodyWhite.withOpacity(0.5),
                                  width: context.width(),
                                  padding: EdgeInsets.symmetric(vertical: 8),
                                  child: Text("Expired", style: boldTextStyle())
                                      .center(),
                                ),
                            ],
                          ),
