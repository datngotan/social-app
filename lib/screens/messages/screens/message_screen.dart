...
import 'package:socialNetwork/screens/messages/components/search_message_component.dart';
import 'package:socialNetwork/screens/messages/functions.dart';
import 'package:socialNetwork/screens/messages/screens/favourite_message_screen.dart';
import 'package:socialNetwork/screens/messages/screens/new_chat_screen.dart';
import 'package:socialNetwork/screens/messages/screens/user_settings_screen.dart';
...
class _MessageScreenState extends State<MessageScreen> {
  ...
  void initState() {
    ...
    final message =
        '40["$WEB_SOCKET_DOMAIN",${appStore.loginUserId},"${messageStore.bmSecretKey}"]';
  ...
  Future<void> search() async {
    ...
    await searchMessage(searchText: searchController.text.validate())
        .then((value) {
