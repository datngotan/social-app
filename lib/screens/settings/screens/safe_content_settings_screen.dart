...
class SafeContentSettingsScreen extends StatefulWidget {
  ...
  @override
  State<SafeContentSettingsScreen> createState() =>
      _SafeContentSettingsScreenState();
}
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(language.filter, style: boldTextStyle())
                        .paddingTop(12),
                    6.height,
                    Text(language.contentFilterText,
            ...
            16.height,
            ExpansionTile(
              title: Text(language.moreAboutContentSafety,
