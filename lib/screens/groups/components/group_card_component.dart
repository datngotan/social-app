      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset(
                widget.data.groupType == AccountType.private
                    ? ic_lock
                    : ic_globe_antarctic,
                height: 16,
                width: 16,
              ...
              4.width,
              Text(widget.data.groupType.validate(),
              ...
              TextButton(
                onPressed: () {
                  if (widget.data.isGroupAdmin.validate() &&
                      widget.data.groupType == AccountType.privateGroup) {
                  ...
                  } else if (widget.data.groupType == AccountType.public ||
                      widget.data.isGroupMember.validate()) {
                    GroupMemberScreen(
                      creatorId: widget.data.groupCreatedById.validate(),
                      groupId: widget.data.id.validate(),
                      isAdmin: widget.data.isGroupAdmin.validate(),
