...
class AddNewParticipantComponent extends StatefulWidget {
  ...
  @override
  State<AddNewParticipantComponent> createState() =>
      _AddNewParticipantComponentState();
}

class _AddNewParticipantComponentState
    extends State<AddNewParticipantComponent> {
  ...
  Future<void> suggestions() async {
    ...
    await getSuggestions(
            searchText: searchController.text, threadId: widget.threadId)
        .then((value) {
      isLoading = false;
  ...
  Future<void> addParticipantsInChat() async {
    ...
    if (listOfParticipant.isNotEmpty) {
      ...
      await addParticipant(
              listOfParticipant: listOfParticipant, threadId: widget.threadId)
          .then((value) async {
        isLoading = false;
        setState(() {});
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    8.height,
                    Text(language.addParticipantText,
