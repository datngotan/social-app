...
class _NewChatScreenState extends State<NewChatScreen> {
  ...
  Future<void> search() async {
    ...
    await getSuggestions(searchText: searchController.text.validate())
        .then((value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(language.startANewConversation,
              ...
              children: [
                AppTextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Text('${language.to}:', style: boldTextStyle())
