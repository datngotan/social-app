...
class _RestoreComponentState extends State<RestoreComponent>
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(language.conversationDeleted,
                        style: boldTextStyle(color: Colors.white)),
                    Text(
                      language.restore,
                      ...
                      setState(() {});
                      await restoreThread(threadId: widget.threadId.validate())
                          .then((value) {
