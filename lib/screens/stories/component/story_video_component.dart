...
class _CreateVideoStoryState extends State<CreateVideoStory> {
  ...
  void initState() {
    ...
    videoPlayerController = CachedVideoPlayerController.file(widget.videoFile)
...
class _CreateVideoThumbnailState extends State<CreateVideoThumbnail> {
  ...
  Widget build(BuildContext context) {
    if (controller.value.isInitialized) {
      return vc.VideoPlayer(controller)
      ...
      return Container(
        ...
        child:
            Image.asset(ic_video, height: 20, width: 20, fit: BoxFit.contain),
      );
    }
  }
}
...
class ShowVideoThumbnailState extends State<ShowVideoThumbnail> {
  ...
  Widget build(BuildContext context) {
    ...
    return controller.value.isInitialized
        ? vc.VideoPlayer(controller).cornerRadiusWithClipRRect(24)
        ...
        child: AspectRatio(
          ...
          child: Stack(
            ...
            children: <Widget>[
              ...
              vc.VideoProgressIndicator(videoPlayerController,
                  allowScrubbing: true),
            ],
          ),
        ),
