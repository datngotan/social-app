...
import 'package:socialNetwork/models/woo_commerce/billing_address_model.dart';
import 'package:socialNetwork/models/woo_commerce/cart_item_model.dart';
...
import 'package:socialNetwork/screens/shop/components/cart_coupons_component.dart';
import 'package:socialNetwork/screens/shop/components/price_widget.dart';
import 'package:socialNetwork/screens/shop/screens/edit_shop_details_screen.dart';
import 'package:socialNetwork/screens/shop/screens/order_detail_screen.dart';
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                    '${cartItem.quantity.validate()}*${getPrice(cartItem.prices!.currencySymbol.validate())}${getPrice(cartItem.prices!.price.validate())}',
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            PriceWidget(
                                price: getPrice(
                                    (cart.totals!.totalItems.validate().toInt())
                                        .toString()),
                                size: 16),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            PriceWidget(
                                price: getPrice(
                                    cart.totals!.totalPrice.toString()),
                                size: 16),
                          ],
                        ),
                      ],
