...
import 'package:socialNetwork/screens/lms/screens/lms_order_screen.dart';
...
class _BuyCourseScreenState extends State<BuyCourseScreen> {
  ...
  Future<void> init() async {
    ...
    await getLmsPayments().then((value) {
      ...
      selectedPaymentMethod = paymentGateways
          .firstWhere((element) => element.isSelected.validate());
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text('${language.yourOrder}:',
                      style: boldTextStyle(size: 18)),
                  16.height,
                  Row(
                    children: [
                      cachedImage(widget.courseImage,
                              height: 60, width: 60, fit: BoxFit.cover)
                          .cornerRadiusWithClipRRect(commonRadius),
                      16.width,
                      Text(widget.courseName.validate(),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(widget.coursePriseRendered.validate(),
                          ...
                          child: Row(
                            children: [
                              Icon(
                                ...
                                color: selectedPaymentMethod!.id == payment.id
              ...
              onTap: () async {
                ifNotTester(() async {
                  if (selectedPaymentMethod != null) {
                    if (selectedPaymentMethod!.id.validate() ==
                        'offline-payment') {
                      ...
                      await lmsPlaceOrder(
                        ...
                        finish(context);
                        LmsOrderScreen(
                                orderDetail: value, isFromCheckOutScreen: true)
                            .launch(context)
                            .then((value) {
