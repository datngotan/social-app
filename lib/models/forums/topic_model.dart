...
class TopicModel {
  ...
  factory TopicModel.fromJson(Map<String, dynamic> json) {
    return TopicModel(
      ...
      postList: json['post_list'] != null
          ? (json['post_list'] as List)
              .map((i) => TopicReplyModel.fromJson(i))
              .toList()
          : null,
      title: json['title'],
      voicesCount: json['voices_count'].toString(),
      freshness: json['freshness'] != null
          ? (json['freshness'] as List)
              .map((i) => FreshnessModel.fromJson(i))
              .toList()
          : null,
      lastUpdate: json['last_update'],
      isUserVerified: json['is_user_verified'],
      tags: json['tags'] != null
          ? (json['tags'] as List).map((i) => TagsModel.fromJson(i)).toList()
          : null,
    );
  }
