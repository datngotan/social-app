        ...
        child: Column(
          ...
          children: [
            InkWell(
              onTap: () {
                SetChatWallpaperScreen(
                        ...
                        wallpaperUrl: messageStore.globalChatBackground)
                    .launch(context);
              },
              child: Row(
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(language.notifications, style: boldTextStyle(size: 20))
                    ...
                    return InkWell(
                      onTap: () async {
                        ...
                        await saveUserSettings(
                                option: option.id.validate(),
                                value: option.checked.validate())
                            .then((value) {
                          toast(value.message);
                        });
                        init();
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text(option.label.validate(),
                                  style: primaryTextStyle()),
                              Text(option.desc.validate(),
                ...
                16.height,
                Text(language.blockedAccounts, style: boldTextStyle(size: 20))
                    .paddingSymmetric(horizontal: 16),
                8.height,
                Text(
                ...
                if (blockedUsers.validate().isEmpty && !appStore.isLoading)
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (ctx, index) {
                      ...
                      return Row(
                        children: [
                          cachedImage(user.memberAvtarImage,
                                  height: 40, width: 40)
                          ...
                          Column(
                            children: [
                              ...
                              4.height,
                              Text(user.mentionName.validate(),
                          ...
                          AppButton(
                            ...
                            onTap: () async {
                              await unblockUser(userId: user.id.validate())
                                  .then((value) {
                                init();
                              });
                            },
