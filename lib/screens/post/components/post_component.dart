...
import 'package:socialNetwork/screens/blog/screens/blog_detail_screen.dart';
import 'package:socialNetwork/screens/post/components/like_button_widget.dart';
import 'package:socialNetwork/screens/post/components/quick_view_post_widget.dart';
...
import 'package:socialNetwork/models/reactions/reactions_count_model.dart';
import 'package:socialNetwork/network/rest_apis.dart';
import 'package:socialNetwork/screens/blockReport/components/show_report_dialog.dart';
...
import 'package:socialNetwork/screens/post/components/hidden_post_component.dart';
import 'package:socialNetwork/screens/post/components/popup_menu_button_component.dart';
import 'package:socialNetwork/screens/post/components/post_likes_component.dart';
import 'package:socialNetwork/screens/post/components/post_media_component.dart';
import 'package:socialNetwork/screens/post/components/post_reaction_component.dart';
import 'package:socialNetwork/screens/post/components/reaction_button_widget.dart';
...
import 'package:socialNetwork/utils/overlay_handler.dart';
    ...
    if (widget.post.blogId != null) {
      ...
      await wpPostById(postId: widget.post.blogId.validate()).then((value) {
        ...
        if (value.is_restricted.validate()) {
          ...
          BlogDetailScreen(blogId: widget.post.blogId.validate(), data: value)
              .launch(context);
        }
      }).catchError((e) {
  ...
  Future<void> onFavorites() async {
    ifNotTester(() {
      ...
      favoriteActivity(postId: widget.post.activityId.validate().toInt())
          .then((value) {
        if (widget.post.isFavorites == 0 && widget.fromFavourites)
