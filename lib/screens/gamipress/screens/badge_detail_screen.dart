            ...
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                      text: getFormattedDate(data.date.validate()),
                      style:
                          secondaryTextStyle(size: 14, fontFamily: fontFamily)),
                ],
              ),
              maxLines: 1,
            ...
            if (data.hasEarned.validate()) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border(left: BorderSide(color: appGreenColor, width: 2)),
                ),
                child: Text(language.congratulatesYouAreAchieve,
                    style: primaryTextStyle(color: appGreenColor)),
              ),
            ],
            Text(parseHtmlString(data.content!.rendered.validate()),
