    ...
    return Observer(
      builder: (_) => Stack(
        children: [
          if (widget.highlightList.isNotEmpty)
            AnimatedListView(
              ...
              itemBuilder: (ctx, index) {
                HighlightStoriesModel story =
                    widget.highlightList.validate()[index];
                return InkWell(
                  onTap: () {
                    HighlightStoryPage(
                      showDelete: true,
                  ...
                  child: Row(
                    children: [
                      story.categoryImage != null
                          ...
                          : story.items.validate().first.mediaType.validate() ==
                                  MediaTypes.video
                              ? Container(
                      ...
                      16.width,
                      Text(story.categoryName.validate(),
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ifNotTester(() {
                              ...
                              deleteStory(
                                      storyId: story.categoryId.validate(),
                                      type: StoryHighlightOptions.category,
          ...
          if ((widget.highlightList.isEmpty ||
                  widget.highlightList[0].items!.isEmpty) &&
              !appStore.isLoading)
            Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                ...
                TextButton(
                  style: ButtonStyle(
                    ...
                    side: MaterialStateProperty.all(
                        BorderSide(color: appColorPrimary.withOpacity(0.5))),
                  ),
                  onPressed: () {
