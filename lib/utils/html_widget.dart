...
import 'package:socialNetwork/components/table_view_widget.dart';
import 'package:socialNetwork/components/vimeo_embed_widget.dart';
import 'package:socialNetwork/components/youtube_embed_widget.dart';
...
import 'package:socialNetwork/screens/post/screens/pdf_screen.dart';
...
class HtmlWidget extends StatelessWidget {
  ...
  Style commonStyle({
    ...
    return Style(
      ...
      border: border,
      color:
          passedColor != null ? passedColor : color ?? textPrimaryColorGlobal,
      alignment: alignment,
      fontStyle: fontStyle,
      fontWeight: fontWeight,
    ...
    return Column(
      children: [
        if (postContent.validate().contains('youtube_url'))
          YoutubeComponent(postContent: postContent.validate()),
        Html(
            ...
            if (s!.split('/').last.contains('.pdf')) {
              ...
              if (s.contains('?user_id=')) {
                if (s.contains('&is_mention=1')) {
                  MemberProfileScreen(
                          memberId: s
                              .splitBetween('?user_id=', '&is_mention=1')
                              .toInt())
                      .launch(context);
                } else {
                  MemberProfileScreen(
                          memberId: s.splitAfter('?user_id=').toInt())
                      .launch(context);
                }
              } else {
                if (blogId != null) {
                  ...
                  await wpPostById(postId: blogId.validate()).then((value) {
                    ...
                    if (value.is_restricted.validate()) {
                      ...
                      BlogDetailScreen(blogId: blogId.validate(), data: value)
                          .launch(context);
                    }
                  }).catchError((e) {
          ...
          extensions: [
            ...
            TagExtension(
              ...
              builder: (extensionContext) {
                ...
                } else if (extensionContext.innerHtml
                    .validate()
                    .contains('img')) {
                  String img = '';

                  img = extensionContext.innerHtml
                      .splitAfter('<a href="')
                      .splitBefore('"><img loading');
                  if (img.isNotEmpty) {
            ...
            TagExtension(
              ...
              builder: (extensionContext) {
                if (extensionContext.attributes.containsKey('class')) {
                  ...
                  return YouTubeEmbedWidget(extensionContext.attributes['src']
                      .validate()
                      .toYouTubeId());
                }
              },
            ...
            TagExtension(
              ...
              builder: (extensionContext) {
                ...
                } else if (extensionContext.attributes
