  ...
  factory Links.fromJson(Map<String, dynamic> json) {
    return Links(
      about: json['about'] != null
          ? (json['about'] as List).map((i) => User.fromJson(i)).toList()
          : null,
      author: json['author'] != null
          ? (json['author'] as List).map((i) => User.fromJson(i)).toList()
          : null,
      ...
      curies: json['curies'] != null
          ? (json['curies'] as List).map((i) => User.fromJson(i)).toList()
          : null,
      ...
      replies: json['replies'] != null
          ? (json['replies'] as List).map((i) => User.fromJson(i)).toList()
          : null,
      self: json['self'] != null
      ...
      wpTerm: json['wp:term'] != null
          ? (json['wp:term'] as List).map((i) => User.fromJson(i)).toList()
          : null,
    );
  }
