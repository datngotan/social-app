...
import 'package:socialNetwork/components/file_picker_dialog_component.dart';
...
import 'package:socialNetwork/screens/stories/component/attch_link_dialog.dart';
import 'package:socialNetwork/screens/stories/component/set_story_duration.dart';
import 'package:socialNetwork/screens/stories/component/story_video_component.dart';
  ...
  void initState() {
    ...
    if (widget.cameraImage != null && !widget.isCameraVideo) {
      mediaList.add(MediaSourceModel(
        ...
        extension:
            widget.cameraImage!.path.validate().split("/").last.split(".").last,
          ...
          PageView.builder(
            ...
            onPageChanged: (index) {
              ...
              if (storyContentList[index].storyText.validate().isNotEmpty) {
                storyTextController.text =
                    storyContentList[index].storyText.validate();
              } else {
                storyTextController.text = '';
              }
              linkText = storyContentList[index].storyLink != null
                  ? storyContentList[index].storyLink.validate()
                  : "";
              setState(() {});
            },
            itemBuilder: (ctx, index) {
              if (mediaList[index].mediaType == MediaTypes.video) {
                ...
                return Image.file(mediaList[index].mediaFile,
            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    ...List<Color>.generate(
                            20, (index) => Colors.black.withAlpha(index * 10))
                        .reversed,
                    Colors.transparent,
                    Colors.transparent,
                  ],
              ...
              child: Row(
                ...
                children: [
                  IconButton(
                    icon: Image.asset(ic_close_square,
                        color: Colors.white,
                        height: 30,
                        width: 30,
                        fit: BoxFit.cover),
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AttachLinkDialog(
                                ...
                                onSubmit: (text) {
                                  linkText = text;
                                  storyContentList[selectedMediaIndex]
                                      .storyLink = text;
                                  finish(context);
                                  setState(() {});
                                },
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                title: Text(language.setStoryDuration,
                                    style: boldTextStyle()),
                                content: SetStoryDuration(
                                  onTap: (val) {
                                    storyContentList[selectedMediaIndex]
                                        .storyDuration = val.toString();
                                    setState(() {});
                                    finish(context);
                                  },
                                  initialValue:
                              ...
                              return Stack(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 86,
                                    width: 70,
                                    child: CreateVideoThumbnail(
                                        videoFile: mediaList[index].mediaFile),
                                  ),
                                  Container(
                                    child: Image.asset(ic_close,
                                        width: 10,
                                        height: 10,
                                        color: context.primaryColor),
                                    decoration: BoxDecoration(
                    ...
                    children: [
                      AppTextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle:
                              secondaryTextStyle(color: Colors.grey.shade500),
                      ...
                      Container(
                        ...
                        if (widget.isHighlight &&
                            storyActions.validate().any((element) =>
                                element.action ==
                                StoryHighlightOptions.trash)) {
                          showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return Dialog(
                                      ...
                                      TextIcon(
                                        ...
                                        textStyle: primaryTextStyle(
                                            color: appStore.isDarkMode
                                                ? bodyDark
                                                : bodyWhite),
                                        prefix: cachedImage(ic_close_square,
                                            height: 18,
                                            width: 18,
                                            fit: BoxFit.cover,
                                            color: appStore.isDarkMode
