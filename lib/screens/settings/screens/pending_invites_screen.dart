...
import 'package:socialNetwork/screens/settings/components/pending_invites_card_component.dart';
...
class _PendingInvitesScreenState extends State<PendingInvitesScreen> {
  ...
  Future<void> deleteInvite(
      {required List id, bool isBulkActions = false}) async {
    appStore.setLoading(true);
                            ...
                            children: [
                              ...
                              AnimatedListView(
                                padding: EdgeInsets.only(
                                    bottom: appStore.isMultiSelect ? 80 : 16),
                                  ...
                                  return PendingInvitesCardComponent(
                                    ...
                                    callback: (id, isResend) {
                                      ...
                                      if (isResend.validate()) {
                                        sendInviteRequest(
                                                id: selectedInviteRequests)
                                            .then(
                                          (value) =>
                                              selectedInviteRequests.remove(id),
                                        );
                                      } else {
                                        deleteInvite(id: selectedInviteRequests)
                                            .then(
                                          (value) =>
                                              selectedInviteRequests.remove(id),
                                        );
                              ...
                              child: Row(
                                ...
                                children: [
                                    ...
                                    child: DropdownButtonHideUnderline(
                                      child: ButtonTheme(
                                        ...
                                        child: DropdownButton<String>(
                                          ...
                                          onChanged: (newValue) {
                                            setState(() {
                                              dropdownBulkActionsValue =
                                                  newValue!;
                                            });
                                          },
                                          items: [
                                            DropdownMenuItem(
                                                child: Text(bulkActionsList[0]),
                                                value: bulkActionsList[0]),
                                            DropdownMenuItem(
                                                child: Text(bulkActionsList[1]),
                                                value: bulkActionsList[1]),
                                            DropdownMenuItem(
                                                child: Text(bulkActionsList[2]),
                                                value: bulkActionsList[2]),
                                          ],
                                        ),
                                      ),
                                    ),
                                  ...
                                  Container(
                                    height: 50,
                                    decoration: BoxDecoration(
                                      color: dropdownBulkActionsValue ==
                                              language.bulkAction
                                    ...
                                    child: Align(
                                      ...
                                      child: Text(
                                        language.apply,
                                        style: primaryTextStyle(
                                            size: 16, color: context.cardColor),
                                      ),
                                    ),
                                  ).onTap(() {
                                    if (dropdownBulkActionsValue ==
                                        language.bulkAction) {
                                      //
                                    } else if (dropdownBulkActionsValue ==
                                        language.resend) {
                                      sendInviteRequest(
                                              id: selectedInviteRequests)
                                          .then(
